        ...
        public void render(float delta) {
            ...
            if (!gogeta.isDamaged()) {
                ...
                if (collides(gogeta)) {
                    ...
                    gogeta.incrementDamageCount(); // Incrementar el contador de daños
                    System.out.println(gogeta.getDamageCount());
                    System.out.println(gogeta.getVidas());
                    if (gogeta.isMaxDamageReached()) {
                        gameover = true;
